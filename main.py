...
# Split for validation (for complexity curve)
...
y_test_pred_proba_lr = lr_model.predict_proba(X_test_pca)
...
# Find best depth (lowest validation loss)
best_depth = depths[np.argmin(val_loss_history)]
print(f"Best depth: {best_depth}")

# Retrain with best depth on full training data
...
# Plot Complexity Curve (Training vs Validation Loss)
